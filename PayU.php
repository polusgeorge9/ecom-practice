...
//$updateResult = $payu_obj->updateOrder($con, $CalcHashString, $resphash, $status, $mihpayid, $txnid);
final class PayU
{
    public $params;
    public $url, $api_url;
    ...
    const SUCCESS_URL = "http://localhost/php_practice/ecom/payment_complete.php";
    const FAILURE_URL = "http://localhost/php_practice/ecom/payment_fail.php";
...
<?php
    ...
    {
        // $redirect_url = 'http://localhost/php_practice/ecom/payment_complete.php';
        $this->api_url = $this->env_prod ? 'https://info.payu.in/merchant/postservice.php?form=2' : 'http://localhost/php_practice/ecom/payment_complete.php';
        ...
        /* if ($response['status'] == 'success') {
            // Redirect the user to the payment completion page
